...
export const WotwModel = ({ ref, ...props }: GroupProps & { route?: string; ref: React.RefObject<THREE.Group> }) => {
...
export const Cart = ({
  ...
  const M = {
    ...
    'Brushed Aluminum Black Stained': new THREE.MeshStandardMaterial({
      color: 0x2b2b2b, // very dark grey metal
      metalness: 1,
      roughness: 0.75,
    }),
    'White leather': new THREE.MeshStandardMaterial({
      color: 0xeeeeee, // off-white
      metalness: 0,
      roughness: 0.9,
    }),
    'Tyre Sidewall': new THREE.MeshStandardMaterial({
      color: 0x1a1a1a, // rubber black
      metalness: 0,
      roughness: 0.95,
    }),
    'Plastic purple red material': new THREE.MeshStandardMaterial({
      color: 0x3d1861, // deep magenta/burgundy plastic (not your accent colors)
      metalness: 0.05,
      roughness: 0.6,
    }),
    'Metal floor': new THREE.MeshStandardMaterial({
      color: 0x1b1b1b, // steel grey
      metalness: 1,
      roughness: 0.6,
    }),
    'Black matte metal': new THREE.MeshStandardMaterial({
      color: 0x1b1b1b,
      metalness: 1,
      roughness: 0.85,
    }),
    ...
    'Dark metal': new THREE.MeshStandardMaterial({
      color: 0x2e2f33,
      metalness: 1,
      roughness: 0.6,
    }),
    'Scratched black metal': new THREE.MeshStandardMaterial({
      color: 0x141414,
      metalness: 1,
      roughness: 0.9,
    }),
    'Plastic 3': new THREE.MeshStandardMaterial({
      color: 0x2b96ba, // mid grey plastic
      metalness: 0.05,
      roughness: 0.55,
    }),
    'Patterned metal': new THREE.MeshStandardMaterial({
      color: 0x132233,
      metalness: 1,
      roughness: 0.65,
    }),
    'Leather Fabric - Black 70': new THREE.MeshStandardMaterial({
      color: 0x0f0f10, // near-black leather
      metalness: 0,
      roughness: 0.9,
    }),
    'SciFi Structural Panelling.006': new THREE.MeshStandardMaterial({
      color: 0x154a54, // light neutral panel paint
      metalness: 0,
      roughness: 0.6,
    }),
    'Steering Plastic': new THREE.MeshStandardMaterial({
  ...
  return (
    <group ref={ref} {...props} dispose={null} position={[0, -0.5, 0]}>
      ...
      />
      <mesh
        geometry={(nodes.steer_1 as THREE.Mesh).geometry}
      ...
      />
      <mesh
        geometry={(nodes.Sweep_12 as THREE.Mesh).geometry}
      ...
      />
      <mesh
        geometry={(nodes.Cylinder_1_4 as THREE.Mesh).geometry}
      ...
      />
      <mesh
        geometry={(nodes.Plane_2_2 as THREE.Mesh).geometry}
      ...
      />
      <mesh
        geometry={(nodes.Plane_1_3 as THREE.Mesh).geometry}
      ...
      />
      <mesh
        geometry={(nodes.Extrude_2003 as THREE.Mesh).geometry}
        material={M['Steering Plastic']}
